...
export const metadata: Metadata = {
  title: "Contas a receber — Reserva 88",
};
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-zinc-500">
            Recebimentos esperados que não vêm de uma venda no Caixa.
          </p>
        </div>
        <Link
      ...
      <div className="rounded-lg border border-zinc-200 bg-white p-6">
        ...
        <ContaForm acao={criarContaReceber} textoBotao="Adicionar" />
      </div>
                    ...
                    <div className="flex justify-end gap-3">
                      {conta.status === "PENDENTE" && (
                        <>
                          ...
                          <form action={cancelarContaReceber.bind(null, conta.id)}>
                            <button
                              type="submit"
                      ...
                      {conta.status === "QUITADA" && (
                        <form action={estornarContaReceber.bind(null, conta.id)}>
                          <button
                            type="submit"
