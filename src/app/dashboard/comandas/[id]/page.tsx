...
import { definirClienteComanda } from "@/app/actions/clientes";
    ...
    <div className="mx-auto flex w-full max-w-xl flex-col gap-6">
      ...
      {aberta && (
        <div className="rounded-lg border border-zinc-200 bg-white p-4">
          <h2 className="mb-3 text-sm font-medium text-zinc-900">Cliente</h2>
          <form
            action={definirClienteComanda.bind(null, comanda.id)}
            className="flex items-center gap-2"
          >
            <select
              name="clienteId"
              defaultValue={comanda.cliente?.id ?? ""}
          ...
          <p className="mt-1 text-xs text-zinc-500">
            Necessário para fechar a comanda com parte do pagamento fiado.
          </p>
        </div>
      )}
